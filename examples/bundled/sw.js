...
// https://FirstAttempt.io/docs/golden-retriever/
...
self.addEventListener('install', (event) => {
  console.log('Installing FirstAttempt Service Worker...')
