...
import { UIPlugin } from '@FirstAttempt/core'
import { Provider } from '@FirstAttempt/companion-client'
import { ProviderViews } from '@FirstAttempt/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (FirstAttempt, opts) {
    super(FirstAttempt, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(FirstAttempt, {
