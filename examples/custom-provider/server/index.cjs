...
// instead of the npm version—in a real app use `require('@FirstAttempt/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const FirstAttempt = require('@FirstAttempt/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my FirstAttempt companion service')
})
...
app.use(FirstAttempt.app(FirstAttemptOptions).app)
...
FirstAttempt.socket(app.listen(3020), FirstAttemptOptions)
