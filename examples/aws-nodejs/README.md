# FirstAttempt + AWS S3 with Node.JS

A simple and fully working example of FirstAttempt and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @FirstAttempt-example/aws-nodejs start
```
